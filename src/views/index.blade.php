...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/mortza/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/mortza/laravel-filemanager/public/js/script.js')) !!}</script>
